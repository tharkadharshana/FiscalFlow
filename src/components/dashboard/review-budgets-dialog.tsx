...
export function ReviewBudgetsDialog({ open, onOpenChange, budgetToEdit }: { open: boolean; onOpenChange: (open: boolean) => void; budgetToEdit?: Budget | null; }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg p-0 flex flex-col h-[90vh]">
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSaveBudgets)} className="flex-1 min-h-0 flex flex-col">
