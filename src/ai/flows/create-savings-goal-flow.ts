...
import { CreateSavingsGoalInputSchema, CreateSavingsGoalOutputSchema } from '@/types/schemas';
import type { CreateSavingsGoalInput, CreateSavingsGoalOutput } from '@/types/schemas';
