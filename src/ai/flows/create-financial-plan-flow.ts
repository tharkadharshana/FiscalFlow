 ...
 * - CreateFinancialPlanInput - The input type for the createFinancialPlan function.
 * - CreateFinancialPlanOutput - The return type for the createFinancialPlan function.
 */
...
const CreateFinancialPlanOutputSchema = z.object({
...
const CreateFinancialPlanInputSchema = z.object({
